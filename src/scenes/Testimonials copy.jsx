...
<div className="md:flex md:justify-between gap-8">
        <motion.div
          className={"bg-[#143c64] mx-auto relative max-w-[400px] h-[100] flex flex-col justify-end p-10 mt-48 before:absolute before:top-[-120px] before:-ml-[110px] before:left-1/2  before:content-person1"}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{ duration: 0.5 }}
        ...
        <motion.div
          className={'bg-[#143c64] mx-auto relative max-w-[400px] h-[350] flex flex-col justify-end p-16 mt-48 before:absolute before:top-[-120px] before:-ml-[110px] before:left-1/2 before:content-person3'}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
        ...
        <motion.div
          className={'bg-[#143c64] mx-auto relative max-w-[400px] h-[350] flex flex-col justify-end p-16 mt-48 before:absolute before:top-[-120px] before:-ml-[110px] before:left-1/2 before:content-person4'}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{delay: 0.4, duration: 0.5 }}
